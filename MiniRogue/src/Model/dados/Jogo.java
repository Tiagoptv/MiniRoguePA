...
public class Jogo {
    ...
    public IEstado comecaJogo() {
        /*estado = new EsperaInicio*/
                return estado;
    }

    public IEstado pedeArea() {
        Menu.ImprimePedeArea();
        return estado;
    }

    public IEstado pedeDificuldade() {
        Menu.ImprimePedeDificuldade();
        return estado;
    }
}
